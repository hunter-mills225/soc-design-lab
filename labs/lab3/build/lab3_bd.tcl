...
################################################################
# This is a generated script based on design: lab3_bd
#
...
proc create_root_design { parentCell } {
  ...
  set data [ create_bd_port -dir I -from 31 -to 0 data ]
  set data_word [ create_bd_port -dir I -from 31 -to 0 data_word ]
  ...
  set scl [ create_bd_port -dir I -from 0 -to 0 scl ]
  set sda [ create_bd_port -dir I -from 0 -to 0 sda ]
  ...
  set block_name lowlevel_dac_intfc
  set block_cell_name lowlevel_dac_intfc_0
  if { [catch {set lowlevel_dac_intfc_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $lowlevel_dac_intfc_0 eq "" } {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports clk125] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins ila_0/clk] [get_bd_pins lowlevel_dac_intfc_0/clk125]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins ila_0/probe3]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins dds_compiler_0/s_axis_phase_tdata]
  connect_bd_net -net data_word_0_1 [get_bd_ports data_word] [get_bd_pins lowlevel_dac_intfc_0/data_word]
  ...
  connect_bd_net -net probe0_0_1 [get_bd_ports data] [get_bd_pins ila_0/probe0]
  connect_bd_net -net probe1_0_1 [get_bd_ports sda] [get_bd_pins ila_0/probe1]
  connect_bd_net -net probe2_0_1 [get_bd_ports scl] [get_bd_pins ila_0/probe2]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins lowlevel_dac_intfc_0/resetn]
  ...
  connect_bd_net -net s_axis_phase_tvalid_0_1 [get_bd_ports s_axis_phase_tvalid_0] [get_bd_pins dds_compiler_0/s_axis_phase_tvalid]
