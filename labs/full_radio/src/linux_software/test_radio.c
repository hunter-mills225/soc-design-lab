...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Hunter Mills - Custom Peripheral Demonstration\n\r");
    *(my_periph+RADIO_TUNER_CONTROL_REG_OFFSET) = 0; // reset PL
    *(my_periph+RADIO_TUNER_CONTROL_REG_OFFSET) = 1; // deassert PL
