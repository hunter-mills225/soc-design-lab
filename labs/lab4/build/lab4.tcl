...
#
# Generated by Vivado on Tue Oct 24 15:28:38 EDT 2023
...
#
#    "/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/lowlevel_dac_intfc.vhd"
#    "/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/mux_2x16b.vhd"
#    "/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/axis_slice_40b_16b.vhd"
#    "/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/top_level.vhd"
#    "/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/matlab/filter1.coe"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../srcs/hdl/lowlevel_dac_intfc.vhd"]"\
 "[file normalize "$origin_dir/../srcs/hdl/mux_2x16b.vhd"]"\
 "[file normalize "$origin_dir/../srcs/hdl/axis_slice_40b_16b.vhd"]"\
...
set file "$origin_dir/../srcs/hdl/lowlevel_dac_intfc.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../srcs/hdl/mux_2x16b.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../srcs/hdl/axis_slice_40b_16b.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize "$origin_dir/../srcs/constraints/lab4.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../srcs/constraints/lab4.xdc"
set file [file normalize $file]
...
if { [get_files lowlevel_dac_intfc.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/lowlevel_dac_intfc.vhd
}
if { [get_files mux_2x16b.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/mux_2x16b.vhd
}
if { [get_files axis_slice_40b_16b.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/axis_slice_40b_16b.vhd
}
if { [get_files axis_slice_40b_16b.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/hmills/JHU/soc-design-lab/labs/lab4/srcs/hdl/axis_slice_40b_16b.vhd
}
...
# Proc to create BD lab4_bd
proc cr_bd_lab4_bd { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# axis_slice_40b_16b, axis_slice_40b_16b, lowlevel_dac_intfc, mux_2x16b
  ...
  set data [ create_bd_port -dir I -from 15 -to 0 data ]
  ...
  # Create instance: axis_slice_40b_16b_0, and set properties
  set block_name axis_slice_40b_16b
  set block_cell_name axis_slice_40b_16b_0
  if { [catch {set axis_slice_40b_16b_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_slice_40b_16b_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: axis_slice_40b_16b_1, and set properties
  set block_name axis_slice_40b_16b
  set block_cell_name axis_slice_40b_16b_1
  if { [catch {set axis_slice_40b_16b_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_slice_40b_16b_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.Coefficient_File {/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/matlab/filter1.coe} \
  ...
  set_property -dict [ list \
   CONFIG.Clock_Frequency {125} \
   CONFIG.CoefficientSource {COE_File} \
   CONFIG.Coefficient_File {/home/hmills/JHU/soc-design-lab/labs/lab4/srcs/matlab/filter2.coe} \
   CONFIG.Coefficient_Fractional_Bits {0} \
   CONFIG.Coefficient_Sets {1} \
   CONFIG.Coefficient_Sign {Signed} \
   CONFIG.Coefficient_Structure {Inferred} \
  ...
  # Create instance: mux_2x16b_0, and set properties
  set block_name mux_2x16b
  set block_cell_name mux_2x16b_0
  if { [catch {set mux_2x16b_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mux_2x16b_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net axis_slice_40b_16b_0_m_axis_data [get_bd_intf_pins axis_slice_40b_16b_0/m_axis_data] [get_bd_intf_pins fir_compiler_1/S_AXIS_DATA]
  connect_bd_intf_net -intf_net fir_compiler_0_M_AXIS_DATA [get_bd_intf_pins axis_slice_40b_16b_0/s_axis_data] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]
  connect_bd_intf_net -intf_net fir_compiler_1_M_AXIS_DATA [get_bd_intf_pins axis_slice_40b_16b_1/s_axis_data] [get_bd_intf_pins fir_compiler_1/M_AXIS_DATA]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports clk125] [get_bd_pins axis_slice_40b_16b_0/clk] [get_bd_pins axis_slice_40b_16b_1/clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins fir_compiler_1/aclk] [get_bd_pins ila_0/clk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins mux_2x16b_0/clk] [get_bd_pins xpm_cdc_gen_0/dest_clk] [get_bd_pins xpm_cdc_gen_1/dest_clk]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins xpm_cdc_gen_0/src_in]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xpm_cdc_gen_1/src_in]
  connect_bd_net -net axis_slice_40b_16b_1_m_axis_data_tdata [get_bd_pins axis_slice_40b_16b_1/m_axis_data_tdata] [get_bd_pins mux_2x16b_0/input_0]
  connect_bd_net -net data_word_0_1 [get_bd_ports data_word] [get_bd_pins lowlevel_dac_intfc_0/data_word]
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins fir_compiler_0/s_axis_data_tdata] [get_bd_pins mux_2x16b_0/input_1]
  ...
  connect_bd_net -net mux_2x16b_0_data_out [get_bd_ports m_axis_data_tdata_0] [get_bd_pins mux_2x16b_0/data_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xpm_cdc_gen_0/src_clk] [get_bd_pins xpm_cdc_gen_1/src_clk]
  ...
  connect_bd_net -net sel_0_1 [get_bd_ports sel] [get_bd_pins mux_2x16b_0/sel]
  connect_bd_net -net xpm_cdc_gen_0_dest_out [get_bd_pins axis_slice_40b_16b_0/resetn] [get_bd_pins axis_slice_40b_16b_1/resetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_compiler_0/aresetn] [get_bd_pins fir_compiler_1/aresetn] [get_bd_pins ila_0/probe3] [get_bd_pins mux_2x16b_0/resetn] [get_bd_pins xpm_cdc_gen_0/dest_out]
  connect_bd_net -net xpm_cdc_gen_1_dest_out [get_bd_pins dds_compiler_0/s_axis_phase_tdata] [get_bd_pins xpm_cdc_gen_1/dest_out]
...
# End of cr_bd_lab4_bd()
cr_bd_lab4_bd ""
set_property REGISTERED_WITH_MANAGER "1" [get_files lab4_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files lab4_bd.bd ] 
...
set obj [get_runs impl_1]
set_property -name "auto_rqs.directory" -value "/home/hmills/soc-design-lab/labs/lab4/build/output/lab4/lab4.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/hmills/soc-design-lab/labs/lab4/build/output/lab4/lab4.srcs/utils_1/imports/impl_1" -objects $obj
